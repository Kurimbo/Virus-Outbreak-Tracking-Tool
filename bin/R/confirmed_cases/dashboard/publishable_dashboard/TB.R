...
library(writexl)
# Set file paths
tb_annual_file <- "bin/R/confirmed_cases/dashboard/publishable_dashboard/TB_Cases_and_Rates_by_County_2017-2021.xlsx"
tb_monthly_file <- "bin/R/confirmed_cases/dashboard/publishable_dashboard/Estimated_Monthly_TB_Cases_Texas_2019-2021.xlsx"
